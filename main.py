...
for r in search('housing', ind, bm25, hybrid, use_hybrid_model=True, use_query_expansion=True)[:10]:
    print(r)

for r in search('hill', ind, bm25, hybrid, use_hybrid_model=True, use_query_expansion=True)[:10]:
    print(r)